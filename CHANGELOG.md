...
### Added
- **M57 (P0) — harness a escala**: `run_m51_sbq_inline.py` agora carrega o corpus via COPY-streaming (reusa o loader do M55), viabilizando o benchmark SBQ vs f32 vs pgvector a **1M×768d** numa box dedicada (droplet DO 8-core/16GB) — o head-to-head decision-grade do gate de superioridade vetorial (M57).
