\echo Use "ALTER EXTENSION theodb_rs UPDATE TO '1.5.0'" to load this file. \quit

-- M137 — salto CONVERGENTE 1.4.0 → 1.5.0.
...
--
-- Convergente porque `1.4.0` rotula catálogos diferentes (a superfície foi 18→48→60→78 funções
-- com a versão congelada). Este script leva QUALQUER um deles ao estado 1.5.0, e é idempotente:
...
/* <begin connected objects> */
-- src/lexical/engine.rs:109
-- theodb_rs::lexical::engine::bm25_build
CREATE OR REPLACE  FUNCTION "bm25_build"(
	"index_id" bigint, /* i64 */
	"table" TEXT, /* & str */
	"id_col" TEXT, /* & str */
	"text_col" TEXT /* & str */
...
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'bm25_build_wrapper';
/* </end connected objects> */

/* <begin connected objects> */
-- src/lexical/engine.rs:155
-- theodb_rs::lexical::engine::bm25_search
...
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'bm25_search_wrapper';
/* </end connected objects> */
...
/* <begin connected objects> */
-- src/am/columnar.rs:102
-- theodb_rs::am::columnar::theodb_columnar_stream_chunk_groups
CREATE OR REPLACE  FUNCTION "theodb_columnar_stream_chunk_groups"() RETURNS bigint /* i64 */
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'theodb_columnar_stream_chunk_groups_wrapper';
/* </end connected objects> */

/* <begin connected objects> */
-- src/am/columnar.rs:287
