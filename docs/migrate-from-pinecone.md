...
## 3. Import — `theodb.import_vectors`
...
Signature: `theodb.import_vectors(target regclass, export jsonb, id_col text DEFAULT 'id', embedding_col text
...
### Large exports — `theodb.import_vectors_chunked` (PROCEDURE, per-batch COMMIT)
...
CALL theodb.import_vectors_chunked(
  'items'::regclass,
  '[{"id":"doc-1","values":[0.12,0.04,0.0],"metadata":{"category":"shoes"}}, ...]'::jsonb,
...
Signature: `theodb.import_vectors_chunked(target regclass, export jsonb, chunk_size int DEFAULT 1000,
