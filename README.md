...
> de recall@10** (ambos alcançam ≥0,99), mas **GAP de throughput** — no ponto recall≥0,99 o ScaNN é ~37× mais
> rápido em QPS (quantização anisotrópica + AH SIMD) que o `theodb_ivfflat` (IVFFlat full-precision). A
