...
## M95 — [ ] honest cost model do vecfilter node — gradua o filtered search de experimental → default-capable *(gated M94)*
...
## M96 — [ ] tuplesort-streaming ambuild — build 100M+ em RAM commodity *(gated M89)*
...
## M97 — [ ] Columnar/HTAP (D2) — DISCOVERY-first do pilar lakehouse *(sem gate — pilar novo)*
