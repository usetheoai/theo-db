...
| [pg_duckdb force_execution sobre heap é 0,52-0,78× do row-executor do PostgreSQL](pgduckdb-sobre-heap-e-mais-lento.md) | Resultados corretos e plano usando DuckDB — e ainda assim mais lento que o executor nativo, em todas as escalas. |
...
| [SBQ: tese de ≥2× QPS falsificada — 0,31 a 0,77× do f32](sbq-sem-vantagem-in-ram.md) | Sete configurações medidas; a vantagem do SBQ só existe sob pressão de RAM, não in-RAM. ADR-0018. |
