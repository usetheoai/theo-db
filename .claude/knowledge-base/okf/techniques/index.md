...
| [Todo log de medição carrega a identidade do binário e da máquina](proveniencia-em-todo-artefato.md) | Sem so_md5, postmaster, nproc, free e loadavg no cabeçalho, um artefato não é evidência — é um número solto. |
