...
| [M169 medido: ClickBench 100M vai de 28/43 para 30/43 — e 2 consultas REGRIDEM](delta-medido-m169-28-para-30.md) | Mesma box, mesmo corpus (99.997.497 linhas), mesmo teto de 300 s, `so_md5` como única variável. Consertadas q20/q32/q33/q34 (as 4 falhas roteadas); regredidas q08/q09 por exaustão de descritores no spill. A byte-identidade NÃO foi executada — "completou" não é "correto". |
