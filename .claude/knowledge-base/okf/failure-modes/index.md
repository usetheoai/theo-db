...
| [Uma contagem agregada credita ao fix unidades que falhavam por outra causa](contagem-agregada-mistura-classes-de-falha.md) | No baseline 100M do M169, 5 das 6 falhas eram agg=False (não roteiam) e só 1 era o defeito que o milestone conserta — mover a contagem 19→N mediria as duas classes juntas. |
