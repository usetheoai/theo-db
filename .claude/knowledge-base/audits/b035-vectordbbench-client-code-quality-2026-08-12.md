# Code Quality Audit: b035-vectordbbench-client
...
- Total findings: 4 (0 HARD, 1 SOFT_CAP, 2 SOFT_FLOOR, 1 INFO)
...
|---|---|---|---|
| `.` | `cargo-udeps` | SOFT_CAP | cargo-udeps auditor unavailable: cargo-udeps exit 101: error: failed to write `/home/paulo/Projetos/theo/theo-platform/theo-db/theodb_rs/target/debug/.fingerprint/zstd-b623b5fb0573f336/lib-zstd`
