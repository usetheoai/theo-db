# Code Quality Audit: m161-expr-routing
...
|---|---|---|---|
| `.` | `cargo-udeps` | SOFT_CAP | cargo-udeps auditor unavailable: cargo-udeps exit 101: Checking datafusion-expr-common v54.0.0
   Compiling pgrx-pg-sys v0.19.0
error: failed to run custom build command for `pgrx-pg-sys v0.19.0`

Caused by:
  process didn't exit successfully: `/home/paul |
